...
const calcularPerimetro = (ladoA, ladoB) => { //calcularPerimetro es el nombre de la funcion SIRVE PARA CALCULAR EL PERIMETRO DE UN RECTANGULO
    return 2 * (ladoA + ladoB); //formula del perimetro el * es para multiplicar
}
const ladoA = parseFloat(prompt("Ingrese el valor del lado A del rectángulo:")); //parseFloat convierte el valor ingresado en un numero con decimales
